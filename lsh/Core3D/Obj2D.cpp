...
void Obj2D::Convert(Vector2 center, float fWidth, float fHeight, std::vector<SimpleVertex>& retList)
{
...
void Obj2D::ConvertIndex(Vector2 center, float fWidth, float fHeight, std::vector<SimpleVertex>& retList)
{
	// 0       1
