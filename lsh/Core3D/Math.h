...
namespace std
{
	template<> struct less<T::Rectangle>
	{
		bool operator()(const T::Rectangle& r1, const T::Rectangle& r2) const
		{
			return ((r1.x < r2.x)
				|| ((r1.x == r2.x) && (r1.y < r2.y))
	...
	template<> struct less<T::Vector2>
	{
		bool operator()(const T::Vector2& V1, const T::Vector2& V2) const
		{
			return ((V1.x < V2.x) || ((V1.x == V2.x) && (V1.y < V2.y)));
		}
	};

	template<> struct less<T::Vector3>
	{
		bool operator()(const T::Vector3& V1, const T::Vector3& V2) const
		{
			return ((V1.x < V2.x)
				|| ((V1.x == V2.x) && (V1.y < V2.y))
	...
	template<> struct less<T::Vector4>
	{
		bool operator()(const T::Vector4& V1, const T::Vector4& V2) const
		{
			return ((V1.x < V2.x)
				|| ((V1.x == V2.x) && (V1.y < V2.y))
				|| ((V1.x == V2.x) && (V1.y == V2.y) && (V1.z < V2.z))
	...
	template<> struct less<T::Plane>
	{
		bool operator()(const T::Plane& P1, const T::Plane& P2) const
		{
			return ((P1.x < P2.x)
				|| ((P1.x == P2.x) && (P1.y < P2.y))
	...
	template<> struct less<T::Quaternion>
	{
		bool operator()(const T::Quaternion& Q1, const T::Quaternion& Q2) const
		{
			return ((Q1.x < Q2.x)
				|| ((Q1.x == Q2.x) && (Q1.y < Q2.y))
	...
	template<> struct less<T::Color>
	{
		bool operator()(const T::Color& C1, const T::Color& C2) const
		{
			return ((C1.x < C2.x)
				|| ((C1.x == C2.x) && (C1.y < C2.y))
	...
	template<> struct less<T::Ray>
	{
		bool operator()(const T::Ray& R1, const T::Ray& R2) const
		{
	...
	template<> struct less<T::Viewport>
	{
		bool operator()(const T::Viewport& vp1, const T::Viewport& vp2) const
		{
