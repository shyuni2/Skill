...
void Obj3D::SetMatrix(T::TMatrix* matWorld, T::TMatrix* matView, T::TMatrix* matProj)
{
...
void Obj3D::AddPosition(T::TVector3 vPos)
{
	// 현재위치
	m_vPos += vPos;
	//  10,10f    ~     w(50, 10)
...
void Obj3D::SetPosition(T::TVector3 vPos)
{
	m_vPos = vPos;
