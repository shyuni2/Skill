...
{	
	...
	m_Camera.m_vCamera = m_PlayerObj.m_vPos + m_PlayerObj.m_vLook * -1.0f * 10.0f + m_PlayerObj.m_vUp * 10.0f;
...
{	
	...
	matRotation.YRotate(g_fGameTimer * 0.0f);
	...
	m_pImmediateContext->PSSetSamplers(0, 1, &DxState::m_pSSPoint);
	m_SkyObj.Render();
