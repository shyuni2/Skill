...
{	
	...
	{
		m_PlayerObj.m_vPos.x -= m_PlayerObj.m_vLight * g_fSecPerFrame * 100.0f;
	}
	...
	{
		m_PlayerObj.m_vPos.z += m_PlayerObj.m_vLook * g_fSecPerFrame * 100.0f;
	}
	...
	m_Camera.m_vCamera = m_PlayerObj.m_vPos + Vector3(0, 50.0f + y, -80.0f);
