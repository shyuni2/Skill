...
bool Sample::Init()
{
	...
	SShader* pVShader = I_Shader.CreateVertexShader(m_pd3dDevice.Get(), L"Box.hlsl", "VS");
	SShader* pPShader = I_Shader.CreatePixelShader(m_pd3dDevice.Get(), L"Box.hlsl", "PS");
	...
	m_pMainCamera->CreateViewMatrix(S::SVector3(0, 25.0f, -50.0f), S::SVector3(0, 0.0f, 0));
