...
bool	Sample::Init()
{
	...
	m_pMainCamera->CreateViewMatrix(	S::SVector3(0, 1000.0f, -10.0f), 
										S::SVector3(0, 0.0f, 0.0f));
	...
	m_vLightPos = SVector3(500, 8000, 100);
...
void Sample::RenderShadow(SMatrix* matView, SMatrix* matProj)
{
	...
	ApplyBS(m_pImmediateContext.Get(), SDxState::m_BSNoneColor);
...
void Sample::RenderMRT(ID3D11DeviceContext* pContext)
{
	...
	S::D3DXMatrixTranspose( &m_MapObj.m_LightConstantList.matLight,
							&m_MapObj.m_LightConstantList.matLight);
