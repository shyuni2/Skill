...
#include "SInput.h"
HRESULT SQuadObject::CreateConstantBuffer(ID3D11Device* pd3dDevice)
{
	HRESULT hr;
...
bool SQuadObject::SetBuffer(ID3D11Device* pd3dDevice)
{
...
void SQuadObject::ComputeKernel(int iRadius )
{	
	float sigma = 1.0f;
	m_iMask = iRadius * 2 + 1;	
...
// 
//--------------------------------------------------------------------------------------
HRESULT SQuadObject::CreateTextures(ID3D11Device* pDevice, UINT iWidth, UINT iHeight)
{
	HRESULT hr = S_OK;
